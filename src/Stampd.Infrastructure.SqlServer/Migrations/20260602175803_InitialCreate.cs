        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourcePdfStorageKey = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    SourcePdfSha256 = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TerminationReason = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    ConcurrencyToken = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresIdentityVerification = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SealingProviderName = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    SealingKeyIdentifier = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    TimestampAuthorityUrl = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    PAdESLevel = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstViewedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    IdentityVerificationMethod = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    DeclineReason = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    AccessToken = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoundsX = table.Column<double>(type: "float", nullable: false),
                    BoundsY = table.Column<double>(type: "float", nullable: false),
                    BoundsWidth = table.Column<double>(type: "float", nullable: false),
                    BoundsHeight = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentHashAtEvent = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
