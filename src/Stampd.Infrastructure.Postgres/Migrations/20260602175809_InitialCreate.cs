        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourcePdfStorageKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    SourcePdfSha256 = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TerminationReason = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    ConcurrencyToken = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresIdentityVerification = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    SigningRequestId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    SealingProviderName = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    SealingKeyIdentifier = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    TimestampAuthorityUrl = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    InvitedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ...
                    IdentityVerificationMethod = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    DeclineReason = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    AccessToken = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoundsX = table.Column<double>(type: "double precision", nullable: false),
                    BoundsY = table.Column<double>(type: "double precision", nullable: false),
                    BoundsWidth = table.Column<double>(type: "double precision", nullable: false),
                    BoundsHeight = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeoCity = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    DocumentHashAtEvent = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
