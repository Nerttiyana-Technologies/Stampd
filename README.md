...
[![Status: v2.2](https://img.shields.io/badge/status-v2.2-1a5698?style=flat-square)](#release-history)
...
| Capability | v1.0 | v1.1 | v1.2 | v1.3 | v2.0 | v2.1 | v2.2 (current) |
|---|---|---|---|---|---|---|---|
| PAdES B-B (basic) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
**v2.3 candidates** — webhook delivery retry observability widget, recipient-funnel cohort analysis (e.g. "weekday vs weekend dispatches"), per-sender productivity dashboard, identity-verification challenge latency p50/p95, audit-trail export to CSV/Parquet for compliance teams.
